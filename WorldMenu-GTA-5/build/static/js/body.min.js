...
{
  //alert("ADD")
  //$('#spoilerAnimation').addClass('fadeInUp');
  inner.style.display = "";
}else
		inner.style.display = "none";
    //alert("REMOVE")
    //$('#spoilerAnimation').addClass('fadeOutDown');
    //$('#spoilerAnimation').removeClass('fadeInUp');
	}
...
ourScene.on("leave", function (event) {
  $('#panel-green').addClass('fadeOutDown');
    ...
    ourScene.setClassToggle('#panel-green' ,'fadeInUp')

  //.setClassToggle('#panel-green' ,'fadeInUp , fadeOut')
  //.addIndicators()
  .addTo(controller);
});
