!function(e, t) {
    ...
    function c(e, t, n, i) {
        if (re.acceptData(e)) {
            ...
            if (u && l[u] && (i || l[u].data) || void 0 !== n || "string" != typeof t)
                return u || (u = s ? e[a] = J.pop() || re.guid++ : a), l[u] || (l[u] = s ? {} : {
                    toJSON: re.noop
    ...
    function j(e, t) {
        for (var n, i, r, o = [], a = 0, s = e.length; a < s; a++)
            i = e[a], i.style && (o[a] = re._data(i, "olddisplay"), n = i.style.display, t ? (o[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && je(i) && (o[a] = re._data(i, "olddisplay", k(i.nodeName)))) : (r = je(i), (n && "none" !== n || !r) && re._data(i, "olddisplay", r ? n : re.css(i, "display"))));
        for (a = 0; a < s; a++)
    ...
    function A(e, t, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; o < 4; o += 2)
            "margin" === n && (a += re.css(e, n + Se[o], !0, r)), i ? ("content" === n && (a -= re.css(e, "padding" + Se[o], !0, r)), "margin" !== n && (a -= re.css(e, "border" + Se[o] + "Width", !0, r))) : (a += re.css(e, "padding" + Se[o], !0, r), "padding" !== n && (a += re.css(e, "border" + Se[o] + "Width", !0, r)));
        return a
    }
    function D(e, t, n) {
        var i = !0,
        ...
        if (r <= 0 || null == r) {
            if (r = tt(e, t, o), (r < 0 || null == r) && (r = e.style[t]), it.test(r))
                return r;
    ...
    function _(e, t) {
        ...
        for (t = t ? 1 : 0; r < 4; r += 2 - t)
            n = Se[r], i["margin" + n] = i["padding" + n] = e;
    ...
    function F(e, t, n) {
        ...
        if (re.isEmptyObject(d))
            ...
            for (i in d)
                a = M(h ? m[i] : 0, i, f), i in m || (m[i] = a.start, h && (a.end = a.start, a.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    function O(e, t) {
        var n,
    ...
    function B(e, t, n) {
        var i,
            ...
            l = function() {
                if (r)
                    return !1;
                for (var t = pt || q(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, a = 0, l = u.tweens.length; a < l; a++)
                    u.tweens[a].run(o);
    ...
    re.fn = re.prototype = {
        ...
        for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || re.isFunction(a) || (a = {}), s === l && (a = this, s--); s < l; s++)
            if (null != (r = arguments[s]))
                for (i in r)
                    e = a[i], n = r[i], a !== n && (u && n && (re.isPlainObject(n) || (t = re.isArray(n))) ? (t ? (t = !1, o = e && re.isArray(e) ? e : []) : o = e && re.isPlainObject(e) ? e : {}, a[i] = re.extend(u, o, n)) : void 0 !== n && (a[i] = n));
        return a
    }, re.extend({
        ...
        proxy: function(e, t) {
            var n,
                i,
                r;
            if ("string" == typeof t && (r = e[t], t = e, e = r), re.isFunction(e))
                return n = Y.call(arguments, 2), i = function() {
    ...
    var ue = function(e) {
        function t(e, t, n, i) {
            var r,
                ...
                h,
                m;
            if ((t ? t.ownerDocument || t : R) !== H && D(t), t = t || H, n = n || [], !e || "string" != typeof e)
                return n;
            ...
            if (_ && !i) {
                ...
                if (w.qsa && (!M || !M.test(e))) {
                    if (p = f = P, h = t, m = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (u = k(e), (f = t.getAttribute("id")) ? p = f.replace(be, "\\$&") : t.setAttribute("id", p), p = "[id='" + p + "'] ", l = u.length; l--;)
                            u[l] = p + d(u[l]);
        ...
        function p(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (a) {
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || r) {
                            if (l = t[P] || (t[P] = {}), (s = l[i]) && s[0] === W && s[1] === o)
                                return u[2] = s[2];
        ...
        function v(e, t, n, r, o, a) {
            return r && !r[P] && (r = v(r)), o && !o[P] && (o = v(o, a)), i(function(i, a, s, l) {
                var u,
                    ...
                    x = n ? o || (i ? e : h || r) ? [] : a : y;
                if (n && n(y, x, s, l), r)
                    for (u = g(x, p), r(u, [], s, l), c = u.length; c--;)
                        (f = u[c]) && (x[p[c]] = !(y[p[c]] = f));
                if (i) {
                    if (o || e) {
                        if (o) {
                        ...
                        for (c = x.length; c--;)
                            (f = x[c]) && (u = o ? te.call(i, f) : d[c]) > -1 && (i[u] = !(a[u] = f))
                    }
                } else
                    x = g(x === a ? x.splice(h, x.length) : x), o ? o(null, a, x, l) : Z.apply(a, x)
            })
        }
        function y(e) {
        ...
        w = t.support = {}, N = t.isXML = function(e) {
            ...
            return n !== H && 9 === n.nodeType && n.documentElement ? (H = n, q = n.documentElement, _ = !N(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function() {
                ...
                if (typeof t.getElementsByClassName !== V && _)
                ...
                var i,
                    ...
                    u = [t];
                if (!o || !s)
                    return e === n ? -1 : t === n ? 1 : o ? -1 : s ? 1 : L ? te.call(L, e) - te.call(L, t) : 0;
                if (o === s)
                    return a(e, t);
            ...
            if ((e.ownerDocument || e) !== H && D(e), n = n.replace(fe, "='$1']"), w.matchesSelector && _ && (!F || !F.test(n)) && (!M || !M.test(n)))
                try {
                    var i = O.call(e, n);
                    ...
                    return 1 === i && 0 === r ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                ...
                                for (; (f = ++p && f && f[m] || (d = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++d || (y && ((f[P] || (f[P] = {}))[e] = [W, d]), f !== t));)
                                    ;
        ...
        return f.prototype = T.filters = T.pseudos, T.setFilters = new f, k = t.tokenize = function(e, n) {
            ...
            for (s = e, l = [], u = T.preFilter; s;) {
                ...
                for (a in T.filter)
                    !(r = he[a].exec(s)) || u[a] && !(r = u[a](r)) || (i = r.shift(), o.push({
                        value: i,
                        type: a,
                        matches: r
                    }), s = s.slice(i.length));
    ...
    var pe,
        ...
        ge = re.fn.init = function(e, t) {
            ...
            if (!e)
                return this;
            if ("string" == typeof e) {
                if (n = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : me.exec(e), !n || !n[1] && t)
        ...
        when: function(e) {
            ...
            if (a > 1)
                for (t = new Array(a), n = new Array(a), i = new Array(a); r < a; r++)
                    o[r] && re.isFunction(o[r].promise) ? o[r].promise().done(u(r, i, o)).fail(l.reject).progress(u(r, n, t)) : --s;
    ...
    re.fn.ready = function(e) {
        ...
        if (!we)
            if (we = re.Deferred(), "complete" === he.readyState)
                ...
                he.addEventListener("DOMContentLoaded", s, !1), e.addEventListener("load", s, !1);
            else {
    ...
    re.extend({
        ...
        queue: function(e, t, n) {
            var i;
            if (e)
                return t = (t || "fx") + "queue", i = re._data(e, t), n && (!i || re.isArray(n) ? i = re._data(e, t, re.makeArray(n)) : i.push(n)), i || []
        },
        ...
        promise: function(e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; a--;)
                n = re._data(o[a], e + "queueHooks"), n && n.empty && (i++, n.empty.add(s));
    ...
    re.event = {
        ...
        add: function(e, t, n, i, r) {
            ...
            if (g) {
                for (n.handler && (l = n, n = l.handler, r = l.selector), n.guid || (n.guid = re.guid++), (a = g.events) || (a = g.events = {}), (c = g.handle) || (c = g.handle = function(e) {
                    ...
                    o = Me.exec(t[s]) || [], p = m = o[1], h = (o[2] || "").split(".").sort(), p && (u = re.event.special[p] || {}, p = (r ? u.delegateType : u.bindType) || p, u = re.event.special[p] || {}, f = re.extend({
                        type: p,
                        origType: m,
                        data: i,
                        handler: n,
            ...
            if (g && (c = g.events)) {
                for (t = (t || "").match(xe) || [""], u = t.length; u--;)
                    if (s = Me.exec(t[u]) || [], p = m = s[1], h = (s[2] || "").split(".").sort(), p) {
                        for (f = re.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, d = c[p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = o = d.length; o--;)
                            a = d[o], !r && m !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || i && i !== a.selector && ("**" !== i || !a.selector) || (d.splice(o, 1), a.selector && d.delegateCount--, f.remove && f.remove.call(e, a));
                        l && !d.length && (f.teardown && f.teardown.call(e, h, g.handle) !== !1 || re.removeEvent(e, p, g.handle), delete c[p])
                    } else
                        for (p in c)
                            re.event.remove(e, p + t[u], n, i, !0);
        ...
        trigger: function(t, n, i, r) {
            ...
            if (s = c = i = i || he, 3 !== i.nodeType && 8 !== i.nodeType && !_e.test(p + re.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), a = p.indexOf(":") < 0 && "on" + p, t = t[re.expando] ? t : new re.Event(p, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : re.makeArray(n, [t]), u = re.event.special[p] || {}, r || !u.trigger || u.trigger.apply(i, n) !== !1)) {
                if (!r && !u.noBubble && !re.isWindow(i)) {
                    for (l = u.delegateType || p, _e.test(l + p) || (s = s.parentNode); s; s = s.parentNode)
                        d.push(s), c = s;
                    c === (i.ownerDocument || he) && d.push(c.defaultView || c.parentWindow || e)
                }
                for (f = 0; (s = d[f++]) && !t.isPropagationStopped();)
                    t.type = f > 1 ? l : u.bindType || p, o = (re._data(s, "events") || {})[t.type] && re._data(s, "handle"), o && o.apply(s, n), o = a && s[a], o && o.apply && re.acceptData(s) && (t.result = o.apply(s, n), t.result === !1 && t.preventDefault());
            ...
            if (s[0] = e, e.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, e) !== !1) {
                for (a = re.event.handlers.call(this, e, l), t = 0; (r = a[t++]) && !e.isPropagationStopped();)
                    for (e.currentTarget = r.elem, o = 0; (i = r.handlers[o++]) && !e.isImmediatePropagationStopped();)
                        e.namespace_re && !e.namespace_re.test(i.namespace) || (e.handleObj = i, e.data = i.data, n = ((re.event.special[i.origType] || {}).handle || i.handler).apply(r.elem, s), void 0 !== n && (e.result = n) === !1 && (e.preventDefault(), e.stopPropagation()));
        ...
        fix: function(e) {
            ...
            var t,
                ...
                o = e,
                a = this.fixHooks[r];
            for (a || (this.fixHooks[r] = a = qe.test(r) ? this.mouseHooks : He.test(r) ? this.keyHooks : {}), i = a.props ? this.props.concat(a.props) : this.props, e = new re.Event(o), t = i.length; t--;)
                n = i[t], e[n] = o[n];
    ...
    Ye.optgroup = Ye.option, Ye.tbody = Ye.tfoot = Ye.colgroup = Ye.caption = Ye.thead, Ye.th = Ye.td, re.extend({
        clone: function(e, t, n) {
            ...
            if (ne.html5Clone || re.isXMLDoc(e) || !Be.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Ge.innerHTML = e.outerHTML, Ge.removeChild(o = Ge.firstChild)), !(ne.noCloneEvent && ne.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || re.isXMLDoc(e)))
                for (i = g(o), s = g(e), a = 0; null != (r = s[a]); ++a)
                    i[a] && C(r, i[a]);
            if (t)
                if (n)
                    for (s = s || g(e), i = i || g(o), a = 0; null != (r = s[a]); a++)
                        T(r, i[a]);
                else
                    T(e, o);
            ...
            for (var r, o, a, s, l, u, c, f = e.length, d = m(t), p = [], h = 0; h < f; h++)
                if (o = e[h], o || 0 === o)
                    if ("object" === re.type(o))
                        ...
                        for (s = s || d.appendChild(t.createElement("div")), l = (We.exec(o) || ["", ""])[1].toLowerCase(), c = Ye[l] || Ye._default, s.innerHTML = c[1] + o.replace(Re, "<$1></$2>") + c[2], r = c[0]; r--;)
                            s = s.lastChild;
                        ...
                        for (re.merge(p, s.childNodes), s.textContent = ""; s.firstChild;)
        ...
        remove: function(e, t) {
            for (var n, i = e ? re.filter(e, this) : this, r = 0; null != (n = i[r]); r++)
                t || 1 !== n.nodeType || re.cleanData(g(n)), n.parentNode && (t && re.contains(n.ownerDocument, n) && w(g(n, "script")), n.parentNode.removeChild(n));
            return this
        },
        empty: function() {
        ...
        html: function(e) {
            return Le(this, function(e) {
                ...
                if ("string" == typeof e && !Ie.test(e) && (ne.htmlSerialize || !Be.test(e)) && (ne.leadingWhitespace || !Pe.test(e)) && !Ye[(We.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < i; n++)
                            t = this[n] || {}, 1 === t.nodeType && (re.cleanData(g(t, !1)), t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        domManip: function(e, t) {
            ...
            if (u && (s = re.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                for (o = re.map(g(s, "script"), x), r = o.length; l < u; l++)
                    i = s, l !== f && (i = re.clone(i, !0, !0), r && re.merge(o, g(i, "script"))), t.call(this[l], i, l);
                if (r)
                    for (a = o[o.length - 1].ownerDocument, re.map(o, b), l = 0; l < r; l++)
                        i = o[l], Ue.test(i.type || "") && !re._data(i, "globalEval") && re.contains(a, i) && (i.src ? re._evalUrl && re._evalUrl(i.src) : re.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Je, "")));
                s = n = null
            }
            return this
        }
        ...
        re.fn[e] = function(e) {
            for (var n, i = 0, r = [], o = re(e), a = o.length - 1; i <= a; i++)
                n = i === a ? this : this.clone(!0), re(o[i])[t](n), G.apply(r, n.get());
    ...
    re.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r,
                    ...
                    s = re.camelCase(t),
                    l = e.style;
                if (t = re.cssProps[s] || (re.cssProps[s] = S(l, s)), a = re.cssHooks[t] || re.cssHooks[s], void 0 === n)
                    return a && "get" in a && void 0 !== (r = a.get(e, !1, i)) ? r : l[t];
                if (o = typeof n, "string" === o && (r = ut.exec(n)) && (n = (r[1] + 1) * r[2] + parseFloat(re.css(e, t)), o = "number"), null != n && n === n && ("number" !== o || re.cssNumber[s] || (n += "px"), ne.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, i)))))
                    try {
                        l[t] = n
                    } catch (e) {}
            }
        ...
        re.cssHooks[t] = {
            get: function(e, n, i) {
                if (n)
                    return st.test(re.css(e, "display")) && 0 === e.offsetWidth ? re.swap(e, ct, function() {
                        return D(e, t, i)
                    }) : D(e, t, i)
            },
            set: function(e, n, i) {
    ...
    re.fn.extend({
        ...
        attr: function(e, t, n) {
            var i,
                ...
                o = e.nodeType;
            if (e && 3 !== o && 8 !== o && 2 !== o)
                return typeof e.getAttribute === Ce ? re.prop(e, t, n) : (1 === o && re.isXMLDoc(e) || (t = t.toLowerCase(), i = re.attrHooks[t] || (re.expr.match.bool.test(t) ? Tt : wt)), void 0 === n ? i && "get" in i && null !== (r = i.get(e, t)) ? r : (r = re.find.attr(e, t), null == r ? void 0 : r) : null !== n ? i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : void re.removeAttr(e, t))
        },
        removeAttr: function(e, t) {
            ...
            if (o && 1 === e.nodeType)
                for (; n = o[r++];)
                    i = re.propFix[n] || n, re.expr.match.bool.test(n) ? Et && kt || !Nt.test(n) ? e[i] = !1 : e[re.camelCase("default-" + n)] = e[i] = !1 : re.attr(e, n, ""), e.removeAttribute(kt ? n : i)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        set: function(e, t, n) {
            ...
            if (i || e.setAttributeNode(i = e.ownerDocument.createAttribute(n)), i.value = t += "", "value" === n || t === e.getAttribute(n))
                return t
        }
    ...
    re.fn.extend({
        ...
        prop: function(e, t, n) {
            var i,
                ...
                a = e.nodeType;
            if (e && 3 !== a && 8 !== a && 2 !== a)
                return o = 1 !== a || !re.isXMLDoc(e), o && (t = re.propFix[t] || t, r = re.propHooks[t]), void 0 !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : e[t] = n : r && "get" in r && null !== (i = r.get(e, t)) ? i : e[t]
        },
        propHooks: {
            tabIndex: {
                get: function(e) {
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : re.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    ...
                    n !== Ce && "boolean" !== n || (this.className && re._data(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : re._data(this, "__className__") || "")
            })
        },
        hasClass: function(e) {
    ...
    qt = Wt.exec(_t.toLowerCase()) || [], re.extend({
        ...
        ajax: function(e, t) {
            ...
            if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || _t) + "").replace(Mt, "").replace(Rt, qt[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = re.trim(f.dataType || "*").toLowerCase().match(xe) || [""], null == f.crossDomain && (i = Wt.exec(f.url.toLowerCase()), f.crossDomain = !(!i || i[1] === qt[1] && i[2] === qt[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (qt[3] || ("http:" === qt[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = re.param(f.data, f.traditional)), R($t, f, t, w), 2 === x)
                return w;
            ...
            if (f.beforeSend && (f.beforeSend.call(d, w, f) === !1 || 2 === x))
                return w.abort();
            b = "abort";
            for (r in {
                success: 1,
                ...
                send: function(n, i) {
                    ...
                    o.send(e.hasContent && e.data || null), t = function(n, r) {
                        ...
                        if (t && (r || 4 === o.readyState))
                            if (delete Gt[a], t = void 0, o.onreadystatechange = re.noop, r)
    ...
    re.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0])
            return r = t.jsonpCallback = re.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(en, "$1" + r) : t.jsonp !== !1 && (t.url += (Dt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
    ...
    re.offset = {
        ...
        offset: function(e) {
            ...
            var t,
                ...
                o = r && r.ownerDocument;
            if (o)
                return t = o.documentElement, re.contains(t, r) ? (typeof r.getBoundingClientRect !== Ce && (i = r.getBoundingClientRect()), n = V(o), {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || nn; e && !re.nodeName(e, "html") && "static" === re.css(e, "position");)
                    e = e.offsetParent;
                return e || nn
            })
        }
        ...
        re.cssHooks[t] = E(ne.pixelPosition, function(e, n) {
            if (n)
                return n = tt(e, t), it.test(n) ? re(e).position()[t] + "px" : n
        })
    }), re.each({
        Height: "height",
        Width: "width"
...
}(jQuery, window, document), $(".js-nav").navKit(), function(e, t, n, i) {
    function r(t, n) {
        this.options = e.extend({}, o, n), this.element = t, this.init()
    }
    var o = {
...
{
  //alert("ADD")
  //$('#spoilerAnimation').addClass('fadeInLeft');
  inner.style.display = "";
}else
		inner.style.display = "none";
    //alert("REMOVE")
    //$('#spoilerAnimation').addClass('fadeOutDown');
    //$('#spoilerAnimation').removeClass('fadeInLeft');
	}
...
$(document).ready(function(){
  ...
  var ourScene = new ScrollMagic.Scene({
    triggerElement: '#trigger-green'
  })
  .on("enter", function (event) {
    $('#panel-green').removeClass('fadeOutDown');
});
ourScene.on("leave", function (event) {
  $('#panel-green').addClass('fadeOutDown');
});

    ourScene.setClassToggle('#panel-green' ,'fadeInLeft')

  //.setClassToggle('#panel-green' ,'fadeInLeft , fadeOut')
  //.addIndicators()
  .addTo(controller);
});
